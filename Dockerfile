...
COPY ./entrypoint.sh ${ACTIONS_RUNNER_DIR}/entrypoint.sh
COPY ./install-runner.sh ${ACTIONS_RUNNER_DIR}/install-runner.sh

RUN chmod +x ${ACTIONS_RUNNER_DIR}/entrypoint.sh && \
    chmod +x ${ACTIONS_RUNNER_DIR}/install-runner.sh
